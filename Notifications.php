...
if(isset($_POST['BtnSend']))
{
    ...
    $sql = "INSERT INTO Messages (Message,User,Status) VALUES('$Message','$user','No')";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    ...
                    <center><h3>Notifications</h3></center><br>
                    <div class="woo-cart-table mj_carttable">
                        ...
                        <form name="test" action="Notifications.php" method="POST">
                            ...
                            <tr>                               
                                <td colspan="5">
                                    <input type="text" name="TxtMsg" class="form-control" placeholder="Notification" />
                                </td>                              
                                    
                            </tr>
                            <tr>
                                <td >
                                    <input type="text" name="TxtUser" class="form-control" placeholder="to user" />
                                </td> 
                        ...
                        <div class="mj_offerdiv">
                            <div class="mj_updatecart">
                                <input type="submit" value="Send" name="BtnSend" class="mj_mainbtn mj_btnyellow" />
                            </div>
                        </div>
                        </form>
                    </div>
