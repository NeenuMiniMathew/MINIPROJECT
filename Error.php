...
<html lang="en">
  ...
  <head>
    ...
    <link href="Contents/css/clean-blog.min.css" rel="stylesheet">
  ...
  <body>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('Contents2/images/error.png ')">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
              <h1>TECHSPOT</h1>
              <span class="subheading">LET'S  GO...</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <script src="Contents/js/clean-blog.min.js"></script>
